...
namespace IR_WebAPI.Controllers
{
    ...
    public class IncidentsController : ControllerBase
    {
        ...
        public IncidentsController(XamarinAccountAppApi_dbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Incident>> PostIncident(Incident incident)
        {
            ...
            return CreatedAtAction("GetIncident", new { id = incident.IId }, incident);
        }
        ...
        {
            return _context.Incident.Any(e => e.IId == id);
        }
    }
}
