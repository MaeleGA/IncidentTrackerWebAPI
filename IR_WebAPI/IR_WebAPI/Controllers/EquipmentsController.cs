...
namespace IR_WebAPI.Controllers
{
    ...
    public class EquipmentsController : ControllerBase
    {
        ...
        public EquipmentsController(XamarinAccountAppApi_dbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Equipment>> PostEquipment(Equipment equipment)
        {
            ...
            return CreatedAtAction("GetEquipment", new { id = equipment.EId }, equipment);
        }
        ...
        {
            return _context.Equipment.Any(e => e.EId == id);
        }
    }
}
